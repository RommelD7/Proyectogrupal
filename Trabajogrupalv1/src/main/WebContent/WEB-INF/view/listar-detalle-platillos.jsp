...
<section class="px-5 py-5">
    <div class="container">
        ...
        <div class="container" style="text-align: center;">
            <button class="btn btn-primary" onclick="window.location.href='/Trabajogrupalv1/detallePlatillos/findOne?opcion=1'; return false;">
                ...
                <tbody>
                    <c:forEach var="item" items="${detallePlatillos}">
                        <tr>
                            ...
                            <td>
                                <img alt="Imagen del detalle platillo" width="100" height="100" src="${pageContext.request.contextPath}/resources/img/${item.imagen}" />
                            </td>
                            <td>${item.idProductos}</td>
                            <td>${item.idPlatillos}</td>
                            <td>
                                <button class="btn btn-success" onclick="window.location.href='/Trabajogrupalv1/detallePlatillos/findOne?idDetallePlatillos=${item.idDetallePlatillos}&opcion=1'; return false;">
                                    <i class="fa-solid fa-pen-to-square"></i> <!-- Icono de actualizar -->
                                    Actualizar
                                </button>
                                <button class="btn btn-danger" onclick="window.location.href='/Trabajogrupalv1/detallePlatillos/findOne?idDetallePlatillos=${item.idDetallePlatillos}&opcion=2'; return false;">
